...
import { S1412windLayer, dashBoardApiUrl, nodeServerUrl } from '../../../../appConfig';
...
function Cart() {
    ...
    const downloadMap = async (checkedItems) => {
        ...
        try {
            ...
            try {
                const response = await fetch(`${dashBoardApiUrl}/exchangeset/download`, {
                    method: 'POST',
